            ...
            >
              <div className="flex justify-between">
                ...
                <button
                  ...
                  className="px-3 py-1 rounded-full bg-gradient-to-r from-orange-500 to-orange-700 text-white  hover:bg-gradient-to-r hover:from-orange-600 hover:to-orange-800 transition duration-300"
                >
                  + Add Member
                </button>
              </div>
